...
# To use this script. simply uncomment the line below and replace "7-zip" with your requirements!
# Invoke-ApplicationRemoval -UninstallSearchFilter "7-zip" -WhatIf
